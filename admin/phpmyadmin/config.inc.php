 ...
 */
$cfg['PmaAbsoluteUri'] = 'http://www.clubchancel.com/admin/phpmyadmin/';
...
$cfg['Servers'][$i]['user']          = 'club';      // MySQL user
$cfg['Servers'][$i]['password']      = 'cachou';    // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = 'club';      // If set to a db-name, only
