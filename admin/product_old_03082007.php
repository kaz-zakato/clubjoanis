  ...
  <tr>
    ...
    <td>
      <select name='price_min_qty'>
        <option <?php if($price_min_qty=='120') echo "selected "; ?> value='120'>120 btles
        <option <?php if($price_min_qty=='64') echo "selected "; ?> value='64'>64 btles
        <option <?php if($price_min_qty=='48') echo "selected "; ?> value='48'>48 btles
        <option <?php if($price_min_qty=='24') echo "selected "; ?> value='24'>24 btles
        <option <?php if($price_min_qty=='12') echo "selected" ?> value='12'>12 btles
        <option <?php if($price_min_qty=='6'|| $price_min_qty=='') echo "selected "; ?> value='6'>6 btles
        <option <?php if($price_min_qty=='3') echo "selected "; ?> value='3'>3 btles
        <option <?php if($price_min_qty=='1') echo "selected "; ?> value='1'>1 btle
      </select>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <select name='price_max_qty'>
        ...
        <option <?php if($price_max_qty=='120') echo "selected "; ?> value='120'>120 btles
        <option <?php if($price_max_qty=='64') echo "selected "; ?> value='64'>64 btles
        <option <?php if($price_max_qty=='48') echo "selected "; ?> value='48'>48 btles
        <option <?php if($price_max_qty=='24') echo "selected "; ?> value='24'>24 btles
        <option <?php if($price_max_qty=='12') echo "selected "; ?> value='12'>12 btles
        <option <?php if($price_max_qty=='6') echo "selected "; ?> value='6'>6 btles
        <option <?php if($price_max_qty=='3') echo "selected "; ?> value='3'>3 btles
        <option <?php if($price_max_qty=='1') echo "selected "; ?> value='1'>1 btle
      </select>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <select name="product_type">
        ...
        <option <?php if($product_type=='Rosé') echo " selected "; ?>value="Rosé">Rosé
      </select>
    </td>
  </tr>
