...
<span class="titre"><br>
<b>Administration de l'ordre des objets</b>
<br>
<br>
</span>
<?php
...
else
{
	...
	$id=mysql_query("SELECT * FROM product_company WHERE product_flag=2 ORDER by product_company_ordre",$dbh);
...
<br>
<form Name="FormOrdre" Action="liste_objets_ordre.php?list=1&ValidationOrdre=Oui" Method="Post">
