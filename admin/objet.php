...
if(isset($_POST["action"])){
	...
	*****************************************************************************/
		...
		<!--//
		self.location.href='objet.php?product_id=$product_id';
		//-->
		</script>";
	}	
	/*****************************************************************************
	...
	*****************************************************************************/
		...
		if(!$db->query($SQL)) print "erreur SQL"; else 
		{
		unlink($photo);
		unlink($photo2);
		print "<font color=\"#FF0000\"><strong>Suppression de l'objet effectuée !</strong></font>";
		}
	}
	/*****************************************************************************
	* file upload (image)
...
?>
<form method="post" enctype='multipart/form-data' name='objet'>
<input type='hidden' name='page' value='admin/product'>
<input type='hidden' name='action' value='<?php echo $action; ?>'>
<input type='hidden' name='product_id' value='<?php echo $product_id; ?>'>
<input type='hidden' name='product_ordre' value='25'>
...
<table width="100%">
  ...
  <tr>
    ...
    <td>
	   <select name='product_company'>
		...
		$sql = 'SELECT product_company_nom, product_company_id FROM product_company WHERE product_flag = 2';  
		$req = mysql_query($sql); 
  ...
  <input type="hidden" name="product_region" value="12">
...
<!--  <tr>
  ...
  <tr>
    ...
    <td>
      <select name='price_min_qty'>
        <option <?php if($price_min_qty=='8') echo "selected "; ?> value='8'>8 objets
        <option <?php if($price_min_qty=='7') echo "selected "; ?> value='7'>7 objets
        <option <?php if($price_min_qty=='6') echo "selected "; ?> value='6'>6 objets
        <option <?php if($price_min_qty=='5') echo "selected "; ?> value='5'>5 objets
        <option <?php if($price_min_qty=='4') echo "selected" ?> value='4'>4 objets
        <option <?php if($price_min_qty=='3') echo "selected "; ?> value='3'>3 objets
        <option <?php if($price_min_qty=='2') echo "selected "; ?> value='2'>2 objets
        <option <?php if($price_min_qty=='1'|| $price_min_qty=='') echo "selected ";  ?> value='1'>1 objet
      </select>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <select name='price_max_qty'>
        <option <?php if($price_max_qty=='0' || $price_max_qty=='') echo "selected "; ?> value='0'>Aucun
        <option <?php if($price_max_qty=='8') echo "selected "; ?> value='8'>8 objets
        <option <?php if($price_max_qty=='7') echo "selected "; ?> value='7'>7 objets
        <option <?php if($price_max_qty=='6') echo "selected "; ?> value='6'>6 objets
        <option <?php if($price_max_qty=='5') echo "selected "; ?> value='5'>5 objets
        <option <?php if($price_max_qty=='4') echo "selected "; ?> value='4'>4 objets
        <option <?php if($price_max_qty=='3') echo "selected "; ?> value='3'>3 objets
        <option <?php if($price_max_qty=='2') echo "selected "; ?> value='2'>2 objets
        <option <?php if($price_max_qty=='1') echo "selected "; ?> value='1'>1 objet
      </select>
    </td>
  </tr>
    ...
    <td></td>
    <td>
	<input type="hidden" name="product_vol" value="" />
      <select name="product_vol">
	    <option <?php if($product_vol=='') echo "selected "; ?> value=''>Aucun
        <option <?php if($product_vol=='75') echo "selected "; ?> value='75'>75 cl
        <option <?php if($product_vol=='37.5') echo "selected "; ?> value='37.5'>37.5 cl
        <option <?php if($product_vol=='150') echo "selected "; ?> value='150'>150 cl
        <option <?php if($product_vol=='300') echo "selected "; ?> value='300'>300 cl
        <option <?php if($product_vol=='70') echo "selected "; ?> value='70'>70 cl
        <option <?php if($product_vol=='50') echo "selected "; ?> value='50'>50 cl
      </select>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <select name="product_status">
        <option <?php if($product_status=='0') echo "selected "; ?> value='0'>Hors-ligne
        <option <?php if($product_status=='1') echo "selected "; ?> value='1'>En ligne
        <!--<option <?php if($product_status=='2') echo "selected "; ?> value='2'>Offres SpÃ©ciales-->
      </select>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <select name="product_home">
        <option <?php if($product_home=='N') echo "selected "; ?> value='N'>Non
        <option <?php if($product_home=='Y') echo "selected "; ?> value='Y'>Oui
      </select>
    </td>
  </tr>
  <tr>
    <td>
      <span style="color: #FF0000;">Id&eacute;e cadeau</span>
    </td>
    <td></td>
    <td>
      <select name="product_cado">
        <option <?php if($product_cado=='N') echo "selected "; ?> value='N'>Non
        <option <?php if($product_cado=='Y') echo "selected "; ?> value='Y'>Oui
      </select>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td></td>
    <td>
      <img src="<?php echo $dir2.$product_etiq; ?>"><br clear="all">Changer l'Ã©tiquette : <input type="File" name="product_etiq">
    </td>
  </tr>
...
<!--      <select name="product_type">
        <option value="">N.C.
        <option <?php if($product_type=='Rouge') echo " selected "; ?>value="Rouge">Rouge
        <option <?php if($product_type=='Blanc') echo " selected "; ?>value="Blanc">Blanc
        <option <?php if($product_type=='RosÃ©') echo " selected "; ?>value="RosÃ©">RosÃ©
      </select>-->
<!--    </td>
  </tr>-->
...
<?php /*?>  <tr>
    ...
    <td>
      <select name="product_type2">
		<option <?php if($product_type2=='Les objets du vin') echo " selected "; ?>value="Les objets du vin">Les objets du vin
        <option <?php if($product_type2=='Les délices') echo " selected "; ?>value="Les délices">Les délices
      </select>
    </td>
  </tr><?php */?>
  ...
  <p><br>
	  ...
	  <input type="submit" name="Mail.x" value="Enregistrer" class="Bsbttn">
		...
		<input type="submit" value="Supprimer" class="Bsbttn" onClick="document.objet.action.value='delete';if(confirm('Vous allez effacer un objet !\nSouhaitez-vous continuer ?'))submit();">
	</p>
	</td>
  </tr>
