...
if (sizeof($cart) == 0) {
	...
	<br><span class="titre">Votre panier</span><br>
		...
		<font color="#9F0002">Vous devez commander 12 bouteilles ou un coffret ou un objet au minimum </font><font color="marroon"><br /></font> Livraison en France Métropolitaine uniquement</font><br />
	<?php
...
if (THIS_PAGE!="checkout") {
	?>
	<br><span class="titre">Votre panier</span><br>
	<b><font color="#9F0002">Vous devez commander 12 bouteilles ou un coffret ou un objet au minimum </font><font color="marroon"><br /> Livraison en France Métropolitaine uniquement</font></b><br />
	<hr size="1" align="left" color="marroon" width="100%"><br>
	<?php
}
?>
...
<tr class="cart">
	...
	for ($i=0;$i<sizeof($cart);$i++) {
		...
		<?php if(THIS_PAGE!="checkout"){
			...
			<br>
			<?php echo "<a href='cart.php?product_id=" . $cart[$i]["product_id"] . "&func=cartDelete' style='font-size:10px;color:black;text-decoration:none;'>"; ?>
			Supprimer</a>
			<?php
		}else{
  ...
  ?>
	<div align="center" class="small">
		<FORM ACTION="account.php" METHOD="get" NAME="cart">
			...
			<?php if($total_qty < 12){ ?>
			<img src="images/terminer.gif" name="Mail.x" value=" Enregistrer ma commande " border=0 onclick="alert('Vous devez effectuer une commande de 12 bouteilles minimum');">
			<?php } else { ?>
			<a href="account.php"><img src="images/terminer.gif" name="Mail.x" value=" Enregistrer ma commande " border=0></a>
			<?php } ?>
		</FORM>
